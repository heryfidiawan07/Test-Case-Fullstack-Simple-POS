    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-lg-8">
                    <div class="card p-3">
                        <form id="form" action="<?= base_url('product/store') ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="detail" name="detail" autocomplete="off" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="qty_stock" name="qty_stock" autocomplete="off" required>
                            </div>
                            <div class="form-group">
...
$(document).ready(function() {
    $('#photo-label').after('<input type="file" class="form-control dropify" id="photo" name="photo" data-height="285" data-max-file-size="3M" value="" accept="image/png, image/jpeg" style="height: 285px;">')
    $('.dropify').dropify({
        messages: {
